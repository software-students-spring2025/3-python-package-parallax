...
def fortune_story(name):
    stories= [
        f"{name} will wake up one day to find out that his body was taken over by AI. When {name} thought of something, {name}'s body would code it in an instance, but no matter what {name} did, there were always bugs...",
